...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Author : ${green}aixxy.id® ${NC}${YELLOW}(${NC} ${green} XPRESS ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/aixxy7/v3/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/aixxy7/v3/main/Regist"
# USERNAME
rm -f /usr/bin/user
...
KEY="5876827988:AAEBV-ltdyGqr2JcHCJiu0uBhelxmAfWW_g"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/6096"}]]}' 
...
wget -q https://raw.githubusercontent.com/aixxy7/v3/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
cd /bin
git clone  https://github.com/aixxy7/wondershaper.git
cd wondershaper
sudo make install
cd
rm -rf wondershaper
